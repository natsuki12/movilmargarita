...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr >
            ...
            <td style="text-align: right;">{{ number_format((session()->has('currency') ? 1 : $currency->value) * $content->subtotal()) }} Bss</td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <p class="text-info float-right mb-3">Total Precio : 
                                {{ (session()->has('currency') ? 1 : $currency->value) * Cart::total() }}
