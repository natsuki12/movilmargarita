    ...
    <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-xs-1">
            <h6><a href=" "><img src="{{ asset('assets/backend/img/lgm1.png') }}" width="200px" />  </a>
        ...
        <div class="col-xs-5" style="padding-left: 100px">
            <h5><a><img alt="" /> <p></p>
                ...
                <p>    RIF J234322252</p></a>

            </h5>
        </div>
       <div class="col-xs-6 text-right" style="width: 600px">
                            ...
                            <div class="panel-heading">
                                    ...
                                    <h3> 
                                        <br>
                                        Fecha: {{ Carbon\Carbon::now()->formatLocalized('%d de %B del %Y') }}
                                    </h3>
                                    
                            </div>
                            <div class="panel-body">
                                <h4>Estatus de orden : 
                                        <span class="badge {{ $order->order_status == 'aprobada' ? 'badge-success' : 'badge-warning'  }}">{{ $order->order_status }}</span>
                                </h4>
                                <h4>Numero de orden : 
...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="#"> {{ $order_detail->product->name }} </a></td>
            <td class=" text-right ">{{ $unit_cost = number_format($order_detail->unit_cost, 2) }}</td>
            <td class=" text-right ">{{ number_format($unit_cost * $order_detail->quantity, 2) }}</td>
        ...
        <tr >
            ...
            <td style="text-align: right;">{{ number_format($unit_cost * $order_detail->quantity, 2) }} $</td>
        ...
        @endforeach
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    ...
                                    @endif
                                    @if($order->order_status === 'aprobada')
                                        <a href="{{ route('admin.order.download', $order->id) }}" target="_blank" class="btn btn-primary " style="margin-right: 5px;">
...
<script type="text/javascript">
    ...
    <script src="{{ asset('assets/backend/js/boton7.js') }}"></script>
     <script src="{{ asset('assets/backend/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/backend/js/pdf.js') }}"></script>
    <script type="text/javascript">
        var doc = new jsPDF();
var elementHTML = $('#example1').html();
